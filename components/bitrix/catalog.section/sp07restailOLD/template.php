...
?>
                    ...
                    <div class="product-filter">
                        <div class="product-filter__display clearfix">
                            <a href="/category/shop-list.php?SECTION_ID=<?=$arResult['SECTION_ID_MAIN']?>" class="display__list">Список</a>
                            <a href="/category/shop-grid.php?SECTION_ID=<?=$arResult['SECTION_ID_MAIN']?>" class="display__grid display--active">Сетка</a>
                        </div>
...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	<div class="item__wrap">
                                ...
                                <a href="/category/product.php?ELEMENT_ID=<? echo $arItem['ID'];?>">
                                ...
                                <div class="item__buttons <? echo $arItemIDs['BASKET_ACTIONS']; ?>">
                                    <button class="btn btn-quick-buy" data-price-id="<?=$arItem['OFFERS2']['ID']?>" title="Купить в один клик">
                                        <i class="icon icon-hand"></i>
                                    </button>
                                    <button class="btn btn-add-to-cart" data-price-id="<?=$arItem['OFFERS2']['ID']?>"  data-price-id="1" title="Положить в корзину">
