					...
					<tr id="<?=$arItem["ID"]?>">
                        ...
                        <td id="basket_quantity_control">
                            <div class="item__input-counter basket_quantity_control">
                                ...
                                <button type="button" class="btn btn-plus btn-number plus" data-field="QUANTITY_INPUT_<?=$arItem["ID"]?>" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'up', <?=$useFloatQuantityJS?>);">
                                    +
                                </button>
                            </div>
                        </td>
