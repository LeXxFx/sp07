                                    ...
                                    <div id="product-gallery" class="item__image">
                                        <div class="imgs-list">
                                                <!-- <div class="item current">
                                                    <a href="<? echo $arResult['PREVIEW_PICTURE']['SRC']; ?>" data-preview="<? echo $arResult['PREVIEW_PICTURE']['SRC']; ?>" data-source="image">
...
if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS']) && !empty($arResult['OFFERS_PROP']))
{
    $arSkuProps = array();
?>
<div class="item__product-options" id="<? echo $arItemIDs['PROP_DIV']; ?>">
<?
...
?>
            <div class="prop prop-size clearfix">
                ...
                ?>
                    <div class="value sku_prop_value" data-treevalue="<? echo $arProp['ID'].'_'.$arOneValue['ID']; ?>" data-onevalue="<? echo $arOneValue['ID']; ?>">
...
?>
                                    ...
                                    <div class="item__panel is_stuck" style="position: fixed; top: 50px; width: 250px;">
                                        <div class="item__price">
                                            ...
                                            <span class="new"><?=round($arResult['PROPERTIES']['MINIMUM_PRICE_2']['VALUE']); ?></span>
                                        ...
                                        <div class="item__input-counter">
                                            ...
                                            <div class="input-group-text">
                                                <input type="text" name="quant[2]" class="form-control input-number input-area count" value="1" min="1" max="100000" data-step="1" data-unit="">
                                            </div>
                                        ...
                                        <div class="item__buttons">
                                            ...
                                            <button class="btn btn-add-to-cart" data-price-id="<?=$arResult['OFFERS']['0']['ID'];?>"  data-price-id="1" title="Положить в корзину">
                        ...
                        <div class="product-single__price">
                            <div class="item__panel">
                                <div class="item__panel__inner">
                                    ...
                                    <div class="item__buttons">
                                        <button class="btn btn-quick-buy" data-price-id="<?=$arResult['OFFERS']['0']['ID'];?>"  title="Купить в один клик">
                                            <i class="icon icon-hand"></i>
                                        </button>
                                        <button class="btn btn-add-to-cart" data-price-id="<?=$arResult['OFFERS']['0']['ID'];?>"  title="Положить в корзину">
                                            <i class="icon icon-cart-white"></i>
                                        </button>
                                    </div>
                                    <div class="item__delivary">
                        ...
                        <div class="catalog">
                            <div class="catalog__list clearfix slick-initialized slick-slider"><button type="button" data-role="none" class="slick-prev slick-arrow" aria-label="Previous" role="button" style="display: block;"><i class="icon icon-prev-dark"></i></button>
                                <div aria-live="polite" class="slick-list draggable"><div class="slick-track" role="listbox" style="opacity: 1; width: 3588px; transform: translate3d(-1104px, 0px, 0px);"><div class="catalog__item slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1" style="width: 277px;">
                                    <a href="#" tabindex="-1">
                                        <div class="photo" style="background: url(/bitrix/templates/sp07restail/demo/catalog_img2.jpg) no-repeat center 0 / cover">
                                    ...
                                    <a href="#" tabindex="-1">
                                        <div class="photo" style="background: url(/bitrix/templates/sp07restail/demo/catalog_img3.jpg) no-repeat center 0 / cover">
                                            <span>Открыть категорию</span>
                                        </div>
                                        <div class="name">
                                    ...
                                    <a href="#" tabindex="-1">
                                        <div class="photo" style="background: url(/bitrix/templates/sp07restail/demo/catalog_img4.jpg) no-repeat center 0 / cover">
                                            <span>Открыть категорию</span>
                                        </div>
                                        <div class="name">
                                    ...
                                    <a href="#" tabindex="-1">
                                        <div class="photo" style="background: url(/bitrix/templates/sp07restail/demo/catalog_img5.jpg) no-repeat center 0 / cover">
                                            <span>Открыть категорию</span>
                                        </div>
                                        <div class="name">
                                    ...
                                    <a href="#" tabindex="0">
                                        <div class="photo" style="background: url(/bitrix/templates/sp07restail/demo/catalog_img1.jpg) no-repeat center 0 / cover">
                                            <span>Открыть категорию</span>
                                        </div>
                                        <div class="name">
