...
<?endif?>
	...
	<form method="post" action="<?=$arResult["AUTH_FORM"]?>" name="bform" class="form-horizontal">
...
<? endif ?>
		...
		<div class="form-group">
			<div class="col-sm-3">
				<label class="control-label"><?=GetMessage("AUTH_CHECKWORD")?></label>
			</div>
			<div class="col-sm-9">
				<input type="text" class="form-control" name="USER_CHECKWORD" maxlength="255" value="<?=$arResult["USER_CHECKWORD"]?>" />
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-3">
			...
			<div class="col-sm-9">
				...
				<?endif?>
				<input type="password" class="form-control" name="USER_PASSWORD" maxlength="255" value="<?=$arResult["USER_PASSWORD"]?>" autocomplete="off" />
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-3">
			...
			<div class="col-sm-9">
				...
				<?endif?>
				<input type="password" class="form-control" name="USER_CONFIRM_PASSWORD" maxlength="255" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" autocomplete="off" />
			</div>
		</div>
...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="btn btn-success" name="change_pwd" value="<?=GetMessage("AUTH_CHANGE")?>" />
		</div>
