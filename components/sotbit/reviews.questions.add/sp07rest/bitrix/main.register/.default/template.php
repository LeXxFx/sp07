...
<form method="post" action="javascript:void(null);" name="regform" id="registration_question"  enctype="multipart/form-data" data-params='<?=serialize($arParams)?>'>
...
if(screen.width<768)
{
   ...
   $('#registration_question').on("change","input[name='REGISTER[PASSWORD]']" ,function() {
      var login_val = $(this).val();
      $('#registration_question').find("input[name='REGISTER[LOGIN]']").val(login_val);       
   });      
</script>
<?$frame->end();?>