...
$this->addExternalJs('https://api-maps.yandex.ru/2.1.34/?load=package.full&lang=ru-RU');
    ...
    <div class="bx_order_make">
        ...
        else
        {
                ...
                <?if($_POST["is_ajax_post"] != "Y")
            {
                ...
                <p class="title-order info-comment">Комментарии к заказу</p>
                <div class="label-block">
                    <textarea name="ORDER_DESCRIPTION"></textarea>
                </div>   
                <input type="submit" value="Оформить заказ" onclick="submitForm('Y'); return false;" class="submit-order">
...
If($USER->IsAdmin()):
	 echo microtime();
	 echo '<br> microtime template end <br>';
 	endif;
?>
...
(function(d,w){
    ...
    s.async=true;
    s.src="http://track.recreativ.ru/trck.php?shop=1884&del=1&offer=<?=$viv1?>&rnd="+Math.floor(Math.random()*999);
