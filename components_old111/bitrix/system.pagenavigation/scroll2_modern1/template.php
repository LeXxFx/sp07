...
?>
<div class="modern-page-navigation orion_isp orion_isp<?=$arResult["NavNum"]?>"> 
<!--orion_isp_begin<?=$arResult["NavNum"]?> : do not edit or remove this comment! --> 
<?
...
?>
<!--orion_isp_end<?=$arResult["NavNum"]?> : do not edit or remove this comment! --> 
</div>
