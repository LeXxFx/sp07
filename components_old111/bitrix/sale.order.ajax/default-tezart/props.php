...
<?if($arResult["PERSON_TYPE"][1]["CHECKED"]):?>
	...
	<div class="label-block">
		...
		<input id="fullname" type="text" name="ORDER_PROP_1" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"]["1"]["VALUE"]?>" size="100">
	</div> 
	<script type="text/javascript">
		$("#fullname").suggestions({
			serviceUrl: "https://suggestions.dadata.ru/suggestions/api/4_1/rs",
			token: "7a81063b84c717f343ad1ded274e254e888c8857",
			type: "NAME",
			count: 5, 
	...
	<div class="label-block label-float">
		...
		<input id="email" type="text" name="ORDER_PROP_2" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"]["2"]["VALUE"]?>">
	</div>
	<? if($USER->IsAdmin())
	   {  ?>                                 
	<script type="text/javascript">
