...
<div id="basket_items_list">
					...
					<tr id="<?=$arItem["ID"]?>">
						...
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
							...
							?>
								<td class="custom">
									<span><?=$arHeader["name"]; ?>:</span>
									<div class="discount_value" id="discount_value_<?=$arItem["ID"]?>">
							...
							?>
								<td class="custom">
									...
									if ($arHeader["id"] == "SUM"):
									?>
										<div class="sum" id="sum_<?=$arItem["ID"]?>">
									<?
									endif;
						...
						?>
							<td class="control">
								...
								if ($bDeleteColumn):
								?>
									<div class="delete_from_basket"><a style="color: transparent;" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"><!-- тут надо что-нибудь нахерачить --> delete</a> </div><br />
								<?
								endif;
								if ($bDelayColumn):
								?>
	...
	<?
		$all_sum = intval($arResult["allSum"]);
		if($all_sum < 5000):
$minus_sum =5000 - intval($arResult["allSum"]);
?>
	<div class="free-delivery">До <span>бесплатной доставки</span> необходимо купить товара на <?echo $minus_sum?> руб. <a href="/store/">Добавить товар?</a></div>
	<?endif;?>
	<div class="order_block">

		<div class="order_block_left" id="coupons_block">
		<?
		if ($arParams["HIDE_COUPON"] != "Y")
		{
		?>
			<div class="coupon_block">
				<span><?/*=GetMessage("STB_COUPON_PROMT")*/?>У Вас есть купон?</span><br /><input class="coupon_field" type="text" id="coupon" name="COUPON" value=" XXX - XXX - XXX - XXX" onchange="enterCoupon();" onblur="if (this.value == '') this.value = ' XXX - XXX - XXX - XXX';" onfocus="if (this.value == ' XXX - XXX - XXX - XXX') this.value = '';">&nbsp;<div class="activate_coupon_container"><a class="activate_coupon" href="javascript:void(0)" onclick="enterCoupon();" title="<?=GetMessage('SALE_COUPON_APPLY_TITLE'); ?>"><?/*=GetMessage('SALE_COUPON_APPLY'); */?>Активировать</a></div>
			</div><?
...
?>
		...
		<div class="order_block_right">
			<table class="order_block_table">
				...
				<?endif;?>-->
					<tr>
						<td class="sum_title"><?=GetMessage("SALE_TOTAL")?></td>
						<td class="sum_result" id="allSum_FORMATED"><?=str_replace(" ", "&nbsp;", $arResult["allSum_FORMATED"])?></td>
					</tr>
		...
		<div style="clear:both;"></div>
		<div class="sale_button_block">
			<div class="sale_buy_more"><a class="sale_buy_more_a" href="http://sport07.ru/">Продолжить покупки </a></div>
			...
			?>
			<div class="sale_button_container"><a href="javascript:void(0)" onclick="checkOut();" class="sale_button"><?=GetMessage("SALE_ORDER")?></a></div>
		</div>
	</div>
</div>
<?
...
?>
<div class="advantages" style="margin-top:75px;">
	<div class="col-advantages">
		<a href="/delivery/"><img src="http://sport07.ru/upload/medialibrary/38d/38dcc2d226bfe13b92cb96e0df863822.png" alt=""></a><a>
</a><div class="text-advantages"><a>
	</a><a href="/delivery/"><p>Доставка</p></a><a>
	</a><a href="/delivery/"><span>по всей России</span></a><a>
</a></div><a>	</a></div><a>
	</a><div class="col-advantages"><a>
		</a><a href="/guarantee/"><img src="/bitrix/templates/sport07/images/icon-3.png" alt=""></a><a>
</a><div class="text-advantages"><a>
	</a><a href="/guarantee/"><p>Гарантия</p></a><a>
	</a><a href="/guarantee/"><span>купленных у нас товаров</span></a><a>
</a></div><a>
	</a></div><a>
	</a><div class="col-advantages"><a>
		</a><a href="/return-exchange/"><img src="http://sport07.ru/upload/medialibrary/b45/b452591b42aba8237a7672965dee35fc.png" alt=""></a><a>
</a><div class="text-advantages"><a>
	</a><a href="/return-exchange/"><p>Обмен товара</p></a><a>
	</a><a href="/return-exchange/"><span>ненадлежащего качества</span></a><a>
</a></div><a>	</a></div><a>
	<div class="col-advantages">
		<img src="http://sport07.ru/upload/medialibrary/f67/f67d27022f79d719ee377a1e76ea637f.png" alt="">
