...
<div id="basket_items_list">
	...
	<?
		$all_sum = intval($arResult["allSum_FORMATED"]);
		if($all_sum < 5000):
	?>
	<div class="free-delivery">До <span>бесплатной доставки</span> необходимо купить товара на <?=5000-$all_sum?> руб. <a href="/store/">Добавить товар?</a></div>
	<?endif;?>
