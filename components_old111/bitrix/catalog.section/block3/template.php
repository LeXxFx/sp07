		...
		<div class="col-product" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
			<div class="col-product-ins">
				...
				<?
                   ...
                   unset($offer_price_id);
                    foreach($arItem['OFFERS'] as $arOffer) {
                        
                        if(!empty($arOffer['DISPLAY_PROPERTIES']['RAZMER']['DISPLAY_VALUE']))
                        {
                            
                            $offer_price_id[$arOffer['CATALOG_PRICE_ID_2']] = $arOffer['DISPLAY_PROPERTIES']['RAZMER']['DISPLAY_VALUE'];
                        }
                    ...
                    $min_offer_razmer_value_price_id = array_keys($offer_price_id, min($offer_price_id))[0];
				...
				<div class="buy-block">
					<div class="amount">
                     ...
                     <?
                     if(!empty($min_offer_razmer_value_price_id)) { $data_price_id = $min_offer_razmer_value_price_id;}
                     else { $data_price_id = $arItem["OFFERS"][0]["CATALOG_PRICE_ID_2"];}
                     ?>
                
                    <span class="buy-product addtobasket js_buy_btn" data-amount="1" data-id="<?=$arItem["ID"]?>" data-price-id="<?=$data_price_id?>" onmousedown="try { rrApi.addToBasket(<?=$arItem['ID']?>) } catch(e) {}">Купить</span>
...
<?
		...
		if ('Y' == $arParams['PRODUCT_DISPLAY_MODE'])
		{
			...
			{
				$arSkuProps = array();
				?><div class="bx_catalog_item_scu bx_catalog_list_home" id="<? echo $arItemIDs['PROP_DIV']; ?>"><?
...
<div class="bx_catalog_list_home col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?> " style="display:none;">
	<?
