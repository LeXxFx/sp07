...
<div class="row-product" style="margin-top:30px;">
	<p class="title"><?if($arParams["SECTION_TITLE_LINK"] != ""):?><a href="<?=$arParams["SECTION_TITLE_LINK"]?>"><?endif;?><span style="font-size:26px; color:#7d7878;"><?if($arParams["SECTION_TITLE"] != "") echo $arParams["SECTION_TITLE"]; else echo $arResult["NAME"]?></span><?if($arParams["SECTION_TITLE"] != ""):?></a><?endif;?></p>
	<div class="sub-category">
		<?if($arParams["SECTION_TITLE_LINK"] != ""):?><a href="<?=$arParams["SECTION_TITLE_LINK"]?>">Посмотреть все<?if($arResult["ID"]):?> (<?=CIBlockSection::GetSectionElementsCount($arResult["ID"], $arFilter = Array("CNT_ACTIVE"=>"Y"));?>)</a><?endif;?><?endif;?>
	</div>
	<div class="products">
