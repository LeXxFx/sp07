...
?>
			...
			<div class="clb">
			<a href="/include/catalog/element/oneclick.php?id=<?=$arResult["ID"]?>" class="buy-card-fast fancybox fancybox.ajax" onmousedown="try { rrApi.addToBasket(
<?=$arResult["ID"]?>
) } catch(e) {}">Купить в 1 клик</a>
