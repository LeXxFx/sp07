                                        ...
                                        <div class="row">
                                            <div class="col-sm-7">
                                                <div class="checkout-radio-list">
                                                    <div class="item">
                                                        <label>
                                                            <input type="radio" name="44" checked="checked">
                                                            <b>Физическое лицо</b>
                                                        </label>
                                                    </div>
                                                    <div class="item">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="checkout-radio-list">
                                                    ...
                                                    <?foreach($arResult['DELIVERY'] as $key => $arDelivery):?>
                                                        <div class="item">
                                                            <label>
                                                                <input type="radio" <?=($i==0)?'checked="checked"':'';?> name="delivery" class="checkout_delivery" data-price-nf="<?=$arDelivery['PRICE']?>" data-desc="<?=$arDelivery['DESCRIPTION'];?>" data-name="<?=$arDelivery['NAME'];?>" data-price="<?=$arDelivery['PRICE_FORMATED'];?>" value="<?=$arDelivery['ID']?>"/>
                                            ...
                                            <div class="col-sm-7">
                                                <div class="checkout-radio-list">
                                                    ...
                                                    <?foreach($arResult['PAY_SYSTEM'] as $arPay):?>
                                                        <div class="item">
                                                            <label>
                                                                <input type="radio" <?=(($i)==0)?'checked="checked"':'';?> data-name="<?=$arPay['NAME']?>" data-desc="<?=$arPay['DESCRIPTION']?>" class="checkout_payment" name="payment" data-id="<?=$arPay['ID']?>" value="<?=$arPay['ID']?>">
                                                                <b><?=$arPay['NAME']?></b>
                                                            </label>
                                                        </div>
                                                        <?
                            ...
                            <div id="checkout_step5" class="checkout-step__item">
                                ...
                                <div class="checkout-step__body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" name="ORDER_PROP_1" class="form-control" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="tel" name="ORDER_PROP_3" class="form-control masked-phone" placeholder="8 (900) 000-00-00">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="email" name="ORDER_PROP_2" class="form-control" placeholder="ivanov_ivan@mail.ru">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" name="ORDER_PROP_24" class="form-control" placeholder="г. Москва, ул. Алтуфьевское ш., д. 32, к. 1, кв. 154">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col-sm-4">
                                    ...
                                    <div class="buttons clearfix">
                                        ...
                                        <button class="btn btn-primary Checkout_Order">Оформить заказ</button> 
