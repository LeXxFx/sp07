...
?>
                    ...
                    <div class="product-filter">
                        <div class="product-filter__display clearfix">
                            <a href="/store/shop-list.php?SECTION_ID=<?=$arResult['SECTION_ID_MAIN']?>" class="display__list display--active">Список</a>
                            <a href="/store/shop-grid.php?SECTION_ID=<?=$arResult['SECTION_ID_MAIN']?>" class="display__grid">Сетка</a>
                        </div>
                        <div class="product-filter__sorting dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="routeto">
                                <a class="dropdown-item <?=($_GET['order']=='price' && $_GET['sort']=='asc')? 'dropdown-active' : '';?>" href="?SECTION_ID=<?=$_GET['SECTION_ID']?>&order=price&sort=asc">по возрастаню цены</a>
                                <a class="dropdown-item <?=($_GET['order']=='price' && $_GET['sort']=='desc')? 'dropdown-active' : '';?>" href="?SECTION_ID=<?=$_GET['SECTION_ID']?>&order=price&sort=desc">по уменьшению цены</a>
                                <a class="dropdown-item <?=($_GET['order']=='rating' && $_GET['sort']=='desc')? 'dropdown-active' : '';?>" href="?SECTION_ID=<?=$_GET['SECTION_ID']?>&order=rating&sort=desc">по рейтингу</a>
                                <a class="dropdown-item <?=($_GET['order']=='new' && $_GET['sort']=='desc')? 'dropdown-active' : '';?>" href="?SECTION_ID=<?=$_GET['SECTION_ID']?>&order=new&sort=desc">Сортировка: по новизне</a>
                    ...
                    <div class="filter-selected">
                        ...
                        <div class="filter-selected__item">
                            <a class="filter-cancel" title="Отменить выбор"><i class="fa fa-times"></i></a>
                            <span>Размер: 130 см</span>
                        </div>
                        <div class="filter-selected__item">
                            <a class="filter-cancel" title="Отменить выбор"><i class="fa fa-times"></i></a>
                            <span>Товары со скидкой</span>
                        </div>
                        <a href="#" class="filter-cancel-all">Очистить все фильтры</a>
                    </div>
<?
	...
	<div class="item__wrap">
                                <div class="item__image">
                                    <div class="imgs-list">
                                        <div class="item current">
                                            <a href="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" data-preview="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" data-source="image">
                                                <img src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" alt=""/>
                                            </a>
                                        </div>
										<?/*
                                        <div class="item">
                                            <a href="demo/product_img2.jpg" data-preview="demo/product_img2.jpg" data-source="image">
                                                <img src="demo/product_img2.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div class="item">
                                            <a href="demo/product_img4.jpg" data-preview="demo/product_img4.jpg" data-source="image">
                                                <img src="demo/product_img4.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div class="item">
                                            <a href="demo/product_img3.jpg" data-preview="demo/product_img3.jpg" data-source="image">
                                                <img src="demo/product_img3.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div class="item">
                                            <a href="demo/product_img6.png" data-preview="demo/product_img6.png" data-source="image">
                                                <img src="demo/product_img6-1.png" alt=""/>
                                            </a>
                                        </div>
                                        <div class="item">
                                            <a href="demo/product_img5.jpg" data-preview="demo/product_img5-1.jpg" data-source="image">
                                ...
                                <div class="item__info">
                                    <div class="item__name">
                                        <a href="/store/product.php?ELEMENT_ID=<? echo $arItem['ID'];?>"><? echo $productTitle; ?></a>
                                    </div>
                                ...
                                <div class="item__panel">
                                    ...
                                    <div class="item__buttons">
                                        ...
                                        <button id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium btn-add-to-cart" title="Положить в корзину">
